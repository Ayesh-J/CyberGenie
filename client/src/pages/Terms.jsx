...
const TermsAndConditions = () => {
  return (
    <div className="bg-[#14142b] text-white min-h-screen px-6 py-12">
      <div className="max-w-4xl mx-auto space-y-8">
        <h1 className="text-4xl font-bold text-indigo-400">Terms and Conditions</h1>
        <p className="text-sm text-gray-400">Last Updated: June 13, 2025</p>
        ...
        <section>
          <h2 className="text-2xl font-semibold text-indigo-300 mb-2">2. Eligibility</h2>
        ...
        <section>
          <h2 className="text-2xl font-semibold text-indigo-300 mb-2">3. Use of the Platform</h2>
          <p>
        ...
        <section>
          <h2 className="text-2xl font-semibold text-indigo-300 mb-2">4. Intellectual Property</h2>
          <p>
        ...
        <section>
          <h2 className="text-2xl font-semibold text-indigo-300 mb-2">5. User-Generated Content</h2>
          <p>
        ...
        <section>
          <h2 className="text-2xl font-semibold text-indigo-300 mb-2">6. Accounts and Security</h2>
          <p>
        ...
        <section>
          <h2 className="text-2xl font-semibold text-indigo-300 mb-2">7. Termination</h2>
          <p>
        ...
        <section>
          <h2 className="text-2xl font-semibold text-indigo-300 mb-2">8. Disclaimer of Warranties</h2>
          <p>
        ...
        <section>
          <h2 className="text-2xl font-semibold text-indigo-300 mb-2">9. Limitation of Liability</h2>
          <p>
        ...
        <section>
          <h2 className="text-2xl font-semibold text-indigo-300 mb-2">10. Modifications</h2>
          <p>
        ...
        <section>
          <h2 className="text-2xl font-semibold text-indigo-300 mb-2">11. Governing Law</h2>
          <p>
        ...
        <section>
          <h2 className="text-2xl font-semibold text-indigo-300 mb-2">12. Contact Us</h2>
          <p>

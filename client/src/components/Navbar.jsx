...
const Navbar = () => {
  ...
  return (
    <nav className="bg-gradient-to-br from-blue-500 to-purple-700 shadow-md px-6 py-4 flex justify-between items-center hover:shadow-lg">
      {/* Logo + Brand */}
      ...
      <div className="hidden md:flex space-x-4">
        <Link to="/" className="text-white hover:text-blue-600 font-bold text-xl flex gap-1 items-center"> <House />Home</Link>
        <Link to="/learn" className="text-white hover:text-blue-600 font-bold text-xl flex gap-1 items-center"> <GraduationCap />LearnZone</Link>
        <Link to="/quiz" className="text-white hover:text-blue-600 font-bold text-xl flex gap-1 items-center"><BookOpenCheck/>QuizTime</Link>
        <Link to="/dashboard" className="text-white hover:text-blue-600 font-bold text-xl flex gap-1 items-center"><ChartArea/>Dashboard</Link>
      </div>
